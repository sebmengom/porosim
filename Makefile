...
percolator.o: percolator.cpp percolator.h dsu.h dsu.cpp
	g++ -std=c++17 -O2 -Wall -Wextra -c percolator.cpp

montecarlo.o : montecarlo.cpp montecarlo.h percolator.h percolator.cpp
	g++ -std=c++17 -O2 -Wall -Wextra -c montecarlo.cpp

main.o : main.cpp montecarlo.cpp montecarlo.h 
